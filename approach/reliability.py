...
def reliability_local_normalization_as_Sum(all_triples, emb_train_triples, model, entity2embedding, relation2embedding, subgraphs):
    '''
    Getting the reliability sum as currently defined
    '''
    reliability_score = []
                    ...
                    if emb_train_triples.entity_id_to_label[t] in subgraph:
                        for r in range(emb_train_triples.num_relations):
                            ...
                            if ((h,r,t) in all_triples):
                                ...
                                counter_neg += 1
        print()
        print(sum_pos/counter_pos)
        print(sum_neg/counter_neg)
        print()
