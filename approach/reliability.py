...
def reliability_transformation_stretch(all_triples, emb_train_triples, model, entity2embedding, relation2embedding, subgraphs):
    reliability_score_orignial = []
    reliability_score_average = []
    reliability_score_ratio = []
    reliability_score_maxmin = []
