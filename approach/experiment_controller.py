...
def yago2():
    ...
    result = pipeline(training=emb_train_triples,testing=emb_test_triples,model=TransE,random_seed=4,training_loop='LCWA', model_kwargs=dict(embedding_dim=50, batch_size=256),training_kwargs=dict(num_epochs=50), evaluation_fallback= True)   
